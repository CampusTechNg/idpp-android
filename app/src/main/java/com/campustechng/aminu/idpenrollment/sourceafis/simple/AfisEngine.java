package com.campustechng.aminu.idpenrollment.sourceafis.simple;


import com.campustechng.aminu.idpenrollment.sourceafis.extraction.Extractor;
import com.campustechng.aminu.idpenrollment.sourceafis.matching.BestMatchSkipper;
import com.campustechng.aminu.idpenrollment.sourceafis.matching.ParallelMatcher;
import com.campustechng.aminu.idpenrollment.sourceafis.templates.SerializedFormat;
...
//                fp.Decoded = new SerializedFormat().Export(builder);
     ...
     * calling
     * {@link com.google.common.collect.Iterables#getFirst(Iterable, T)
