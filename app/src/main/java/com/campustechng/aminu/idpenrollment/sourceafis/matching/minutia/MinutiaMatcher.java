...
import com.campustechng.aminu.idpenrollment.sourceafis.general.IteratorSink;
import com.campustechng.aminu.idpenrollment.sourceafis.matching.MatchAnalysis;
import com.campustechng.aminu.idpenrollment.sourceafis.matching.MatchScoring;
import com.campustechng.aminu.idpenrollment.sourceafis.matching.ProbeIndex;
...
import com.campustechng.aminu.idpenrollment.sourceafis.meta.ParameterSet;
...
public class MinutiaMatcher
{
    ...
    void CollectEdges(Template candidate)
    {
    	...
    	List<EdgeLookup.LookupResult> matches = edgeLookup.FindMatchingPairs(
    			probeNeighbors,candidateNeigbors);
      
        for(EdgeLookup.LookupResult match : matches)
        {
